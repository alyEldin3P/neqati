...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _initializeControllers() {
    ...
    if (authState is AuthAuthenticated) {
      ...
      _addressController = TextEditingController(text: userData['address'] as String? ?? '');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: AppColors.deepTeal,
        title: AppText('الملف الشخصي', color: AppColors.white, fontWeight: FontWeight.bold),
        centerTitle: true,
        actions: [
          if (!_isEditing)
            IconButton(
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  isExpanded: true,
                  value: _position,
                  items: ['مقاول', 'مهندس', 'فني'].map((String value) {
