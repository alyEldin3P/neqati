...
import 'package:neqati/features/admin/presentation/widgets/stats_card.dart';
import 'package:neqati/features/admin/cubit/admin_cubit.dart';
import 'package:neqati/features/admin/cubit/admin_state.dart';
import 'package:neqati/features/admin/presentation/screens/pending_users_screen.dart';
import 'package:neqati/features/admin/presentation/screens/qr_codes_screen.dart';
import 'package:neqati/features/admin/presentation/screens/qr_code_creation_screen.dart';
import 'package:neqati/features/admin/presentation/screens/users_screen.dart';
import 'package:neqati/features/admin/presentation/screens/gifts_screen.dart';
import 'package:neqati/features/admin/presentation/screens/offers_screen.dart';
import 'package:neqati/features/admin/presentation/screens/admin_levels_screen.dart';
import 'package:neqati/features/admin/presentation/screens/scan_history_screen.dart';
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: AppText.title('لوحة التحكم', color: AppColors.white),
  ...
  Widget _buildDashboard(BuildContext context, AdminStatsLoaded state) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          AppContainer(
            child: state.stats.totalPendingGiftRequests > 0
                ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      AppText(
                      ...
                      ElevatedButton(
                        onPressed: () {
                          // Navigate to gift requests screen
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppColors.deepTeal,
                        ),
                ...
                : Center(
                    child: AppText('لا توجد طلبات هدايا معلقة'),
                  ),
          ),
        ],
      ),
